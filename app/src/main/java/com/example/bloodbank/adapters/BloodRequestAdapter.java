...
import com.example.bloodbank.viewmodels.CustomerUserData;
...
public class BloodRequestAdapter extends RecyclerView.Adapter<BloodRequestAdapter.PostHolder> {
    ...
    private List<CustomerUserData> postLists;
    ...
    public BloodRequestAdapter(List<CustomerUserData> postLists)
    {
    ...
    public void onBindViewHolder(PostHolder postHolder, int i) {
        ...
        CustomerUserData customUserData = postLists.get(i);
